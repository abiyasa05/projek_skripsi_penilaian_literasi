        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 style="margin: 0px">Daftar Topik Litersi</h5>
                            <p>Menampilkan materi Literasi keseluruhan</p>
                        </div>
                    </div>
                            ...
                            <table class="table" style="width: 100%; font-size: 14px" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>07 Aug 2023</td>
                                        <td>
                                            <a style="font-size: 10px" href="{{ url('literacy/teacher/topics/add/'. $topic->id) }}" class="btn btn-sm btn-primary">
                                            ...
                                            <a style="font-size: 10px" onclick="return confirm('Apakah anda ingin menghapus topik ini ?')" href="http://127.0.0.1:8000/literacy/topic/delete/7" class="btn btn-sm btn-outline-danger">
