...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <a class="nav-link active" href="#" onclick="showContent('manage-users')"
                        ...
                        <li class="nav-item">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <a class="nav-link active" href="#" onclick="showContent('manage-materials')"
                        ...
                        <li class="nav-item">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <a class="nav-link" href="#" style="color: #34364A;">AI Generated Questions</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <a class="nav-link active" href="#" onclick="showContent('manage-questions')"
            ...
            <!-- CONTENT -->
            <main class="col-md-9">
                <div id="manage-users" class="content" style="display: none;">
                    ...
                    <div class="container mt-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-info text-white" data-toggle="modal"
                                                    data-target="#detailUserModal{{ $user->id }}">Detail</button>
                        ...
                        @foreach ($users as $user)
                            @include('literacy.teacher.users.modals.detail', ['user' => $user])
                            @include('literacy.teacher.users.modals.edit', ['user' => $user])
                            @include('literacy.teacher.users.modals.delete', ['user' => $user])
                        @endforeach
                    </div>
                </div>

                <div id="manage-materials" class="content" style="display: none;">
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="table-responsive mb-5">
                            <table class="table table-bordered" id="finnishedProgressTable">
                ...
                <div id="manage-questions" class="content" style="display: none;">
                    ...
                    <div class="container mt-4">
                        ...
                        <button class="btn btn-dark mb-3" data-toggle="modal" data-target="#modalTambahPertanyaan">
                            + Tambah Soal
                        </button>
                        ...
                        <div class="table-responsive mb-5">
                                    ...
                                    @forelse ($questions as $index => $question)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-warning" data-toggle="modal"
                                                    data-target="#modalEditPertanyaan{{ $question->id }}">Edit</button>
                                                <button class="btn btn-sm btn-danger" data-toggle="modal"
                                                    data-target="#modalHapusPertanyaan{{ $question->id }}">Hapus</button>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                            ...
                            @foreach ($questions as $question)
                                @include('literacy.teacher.questions.modals.detail', ['question' => $question])
