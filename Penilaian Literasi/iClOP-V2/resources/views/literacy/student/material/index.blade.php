                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <a class="nav-link" href="#" onclick="showContent('validation')"
                                        style="color: #34364A;" id="validationLink">Student Submission</a>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div>
                        <div class="container mt-4">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                {{-- @if($role == "teacher")
                                    <li class="nav-item">
                                        <a class="nav-link" id="material-tab" data-toggle="tab" href="#materials">
                                            Manage Material</a>
                                    </li>
                                @endif --}}
                            </ul>
                            ...
                            <div class="tab-content mt-3">
                                ...
                                {{-- <div class="tab-pane fade" id="materials">
                                    ...
                                    <a href="{{ route('literacy.teacher.materials.create') }}"
                                            ...
                                            <tbody>
                                                @forelse ($materials as $index => $material)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Tombol Edit -->
                                                            <a href="{{ route('literacy.teacher.materials.edit', $material->id) }}"
                                                                class="btn btn-warning btn-sm">Edit</a>

                                                            <!-- Tombol Delete -->
                                                            <form
                                                                action="{{ route('literacy.teacher.materials.destroy', $material->id) }}"
